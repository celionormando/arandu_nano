...
REM
REM  Por que e' mais LENTO que o Arandu Nano:
...
REM    prefira o Arandu Nano 1.1 (Usar_Nano_1.1.bat).
REM ============================================================
cd /d "%~dp0"
...
echo Modelo ativo agora: Katu Mini 2.0 (raciocinio destilado).
