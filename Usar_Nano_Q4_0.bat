@echo off
REM Define o modelo ativo como Arandu Nano 1.1 quantizado em Q4_0 — variante mais
...
echo Modelo ativo agora: Arandu Nano 1.1 Q4_0 (mais rapido em CPUs com AVX2/AVX-512).
